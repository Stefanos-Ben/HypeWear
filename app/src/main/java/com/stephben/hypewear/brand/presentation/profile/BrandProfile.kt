...
fun BrandProfileScreen(
    ...
    val pickImage = rememberLauncherForActivityResult(
        ...
        uri?.let { viewModel.onAction(BrandProfileAction.UploadLogo(it)) }
    }
        ...
        Column(
            ...
            Row(
                ...
                Switch(
                    ...
                    onCheckedChange = { viewModel.onAction(BrandProfileAction.ToggleDarkMode(it)) }
                )
            }
